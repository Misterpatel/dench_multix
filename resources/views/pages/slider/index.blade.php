                    ...
                    <div class="main-container container-fluid">
                        <div class="page-header">
                            <h1 class="page-title">{{$page_title}}   
                                <a href="{{route('add.slider')}}" class=" ms-5 btn btn-primary btn-pill btn-sm"> <i
                                class="fe fe-plus me-1"></i>Add Slider</a> </h1>
                                            ...
                                            <table class="table table-bordered text-nowrap border-bottom" id="file-datatable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="wd-15p border-bottom-0">Button 1 Text</th>
                                                        <th class="wd-15p border-bottom-0">Button 1 Url</th>
                                                        <th class="wd-15p border-bottom-0">Button 2 Text</th>
                                                        <th class="wd-15p border-bottom-0">Button 2 Url</th>
