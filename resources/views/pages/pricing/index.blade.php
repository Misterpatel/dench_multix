                    ...
                    <div class="main-container container-fluid">
                        <div class="page-header">
                            <h1 class="page-title">{{$page_title}}   
                                <a href="{{route('add.pricing')}}" class=" ms-5 btn btn-primary btn-pill btn-sm"> <i
                                class="fe fe-plus me-1"></i>Add Pricing</a> </h1>
                                            ...
                                            <table class="table table-bordered text-nowrap border-bottom" id="file-datatable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="wd-20p border-bottom-0">Subtitle</th>
