...
<body class="app sidebar-mini ltr light-mode">
                    ...
                    <div class="main-container container-fluid">
                        <div class="page-header">
                            <h1 class="page-title">{{$page_title}}   
                                <a href="{{route('add.feature')}}" class=" ms-5 btn btn-primary btn-pill btn-sm"> <i
                                class="fe fe-plus me-1"></i>Add Feature</a> </h1>
    ...
    <script src="{{ asset('/pages/feature.js?v='.time()) }}"></script>
