$(document).ready(function () {
    ...
    $("#slider_submit_btn").on("click", function (e) {
        e.preventDefault();
        if (!pageForm.valid()) {
            return false;
        }
            ...
            success: function (response) {
                ...
                if (obj.res == "1") {
                    ...
                    setInterval(function () {
                        window.location = httpPath + "slider";
                    }, 1000);
                } else if (obj.res == "3") {
                    $("#slider_form").trigger("reset");
                    $("#file-datatable").DataTable().ajax.reload();
...
$(document).ready(function () {
    ...
    var fileDataTable = $('#file-datatable').DataTable({
        ...
        iDisplayLength: 10,
        sAjaxSource: httpPath + "fetch-slider",
