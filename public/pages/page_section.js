...
$('#homeBannerInformationForm').on('submit', function (e) {
    e.preventDefault();
    let formData = $(this).serialize();
    $.ajax({
        url: httpPath + "update-home-bannerInformation",
        headers: {
            "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content")
        },
        type: "POST",
...
$('#homeStoryAspireForm').on('submit', function (e) {
    e.preventDefault();
    let formData = $(this).serialize();
    $.ajax({
        url: httpPath + "update-home-storyAspire",
        headers: {
            "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content")
        },
        type: "POST",
...
$('#homeContactAboutForm').on('submit', function (e) {
    e.preventDefault();
    let formData = $(this).serialize();
    $.ajax({
        url: httpPath + "update-home-contact-about",
        headers: {
            "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content")
        },
        type: "POST",
...
$('#ourPartnersection').on('submit', function (e) {
    e.preventDefault();
    let formData = $(this).serialize();
    $.ajax({
        url: httpPath + "update-our-partner-section",
        headers: {
            "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content")
        },
        type: "POST",
...
$('#aboutFaqPhoto').on('submit', function (e) {
    e.preventDefault(); // Prevent form submission

    var formData = new FormData(this); // Collect form data

    $.ajax({
        url: httpPath + "about-update-faq-photo",
        headers: {
            "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content")
        },
        type: "POST",
...
$('#aboutTestimonialPhoto').on('submit', function (e) {
    e.preventDefault(); // Prevent form submission

    var formData = new FormData(this); // Collect form data

    $.ajax({
        url: httpPath + "about-update-testimonial-photo",
        headers: {
            "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content")
        },
        type: "POST",
