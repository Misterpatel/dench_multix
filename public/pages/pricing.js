$(document).ready(function () {
        ...
        if (typeof pageForm.validate === "function") {
            pageForm.validate({
                ...
                messages: {
                    ...
                    button_text: {
                        required: "Enter Button Text",
                    },
                    button_url: {
                        required: "Enter Button url",
                    },
                },
            });
        }
    ...
    $("#pricing_submit_btn").on("click", function (e) {
        e.preventDefault();
        if (!pageForm.valid()) {
            return false;
        }
            ...
            success: function (response) {
                ...
                if (obj.res == "1") {
                    ...
                    setInterval(function () {
                        window.location = httpPath + "pricing";
                    }, 1000);
                } else if (obj.res == "3") {
                    $("#pricing_form").trigger("reset");
                    $("#file-datatable").DataTable().ajax.reload();
...
$(document).ready(function () {
    ...
    var fileDataTable = $('#file-datatable').DataTable({
        ...
        iDisplayLength: 10,
        sAjaxSource: httpPath + "fetch-pricing",
